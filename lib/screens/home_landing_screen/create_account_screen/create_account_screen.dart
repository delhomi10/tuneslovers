...
class CreateAccountScreen extends StatefulWidget {
  ...
  const CreateAccountScreen({Key? key, required this.firebaseUser})
      : super(key: key);
...
class _CreateAccountScreenState extends State<CreateAccountScreen> {
    ...
    FirebaseFirestore.instance
        ...
        .set(
          Person(
            ...
            isVerified: widget.firebaseUser.emailVerified,
  ...
  void initState() {
    ...
    super.initState();
    setState(() {
      avatarURLController.text = widget.firebaseUser.photoURL ?? "";
      getCurrentAddress();
    });
  }
